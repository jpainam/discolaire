export const routes = {
  ...
  administration: {
    ...
    directory: {
      index: "/admin/directory",
    },
    courses: {
      index: "/admin/courses",
    },
    my_school: {
      index: `/admin/my-school`,
    ...
    sms_management: {
      details: (id: number) => `/admin/sms-management/${id}`,
      history: "/admin/sms-management",
      templates: "/admin/sms-management/templates",
      to_parents: "/admin/sms-management/to-parents",
      to_staffs: "/admin/sms-management/to-staffs",
    },
    grade_management: {
      index: "/admin/grade-management",
      appreciations: "/admin/grade-management/appreciations",
    },
    index: "/admin",
    students: {
      index: "/admin/students",
      import: "/admin/students/import",
      excluded: "/admin/students/excluded",
    },
    transactions: "/admin/accounting/transactions",
    deleteTransactions: "/admin/accounting/transactions/deleted",
    photos: {
      index: "/admin/photos",
      content: "/admin/photos/content",
    },
    users: {
      index: "/admin/users",
    ...
    classrooms: {
      index: "/admin/classrooms",
      levels: `/admin/classrooms/levels`,
      cycles: `/admin/classrooms/cycles`,
      sections: `/admin/classrooms/sections`,
    },
    fees: "/admin/fees",
  },
};
