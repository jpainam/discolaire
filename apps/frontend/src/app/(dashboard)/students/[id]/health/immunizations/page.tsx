...
export default function Page() {
  return (
    <div className="flex w-full flex-col gap-2">
      <ImmunizationHeader />
      <div className="flex flex-col rounded-sm border bg-accent-foreground p-2 text-accent">
        ...
        <TableHeader>
          <TableRow>
            ...
            {vaccines.map((v) => (
              <TableHead
                key={v.name}
                className="border bg-accent-foreground text-center text-accent"
              >
        ...
        <TableBody>
          {immunizations.map((im) => (
            <TableRow key={im.name}>
              <TableCell className="border bg-accent-foreground font-medium text-accent">
                <div className="flex flex-col items-center gap-4 text-center">
