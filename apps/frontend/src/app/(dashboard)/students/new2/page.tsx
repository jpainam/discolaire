...
//         return <Step2 />;
//       case 3:
//         return <Step3 onAddParent={handleAddParent} />;
//       case 4:
//         return <Step4 selectedParents={selectedParents} />;
//       default:
//         return "Unknown step";
//     }
//   };
...
//                 <FieldLabel htmlFor="countryId">{t("citizenship")}</FieldLabel>
//                 <CountryPicker
...
//   onAddParent,
// }: {
//   onAddParent: (data: SelectedParent) => void;
// }) {
//   const trpc = useTRPC();
...
// function Step4({ selectedParents }: { selectedParents: SelectedParent[] }) {
//   const form = useFormContext();
//   const t = useTranslations();
//   const trpc = useTRPC();
