...
const initialBasicInfo: BasicInfo = {
  ...
  isBaptized: initialStudentData.isBaptized,
...
const initialAcademicInfo: AcademicInfo = {
  ...
  dateOfEntry: initialStudentData.dateOfEntry,
  dateOfExit: initialStudentData.dateOfExit,
  isRepeating: initialStudentData.isRepeating,
  isNew: initialStudentData.isNew,
  status: initialStudentData.status,
