...
export function PermissionTable() {
  ...
  //const updateUserPermission = api.permission.update.useMutation({})
  ...
  //const updateUserPermission = (value: string, status: boolean) => {};
  // const debounced = useDebouncedCallback((value: string) => {
  //   void updateUserPermission(value, status);
  // }, 1000);
