    ...
    <Document>
      ...
      >
        <View style={{ flexDirection: "column", display: "flex", gap: 6 }}>
          ...
          >
            <Text>Liste des transactions de l'élève</Text>
            <Text>
          ...
          >
            ...
            >
              ...
              <Text style={{ width: "25%" }}>Ref. Caisse</Text>
            ...
            {transactions.map((tra, index) => {
              return (
                <View
                  ...
                  key={index}
                >
                  <Text style={{ width: "12%", paddingLeft: 2 }}>
                    {tra.createdAt.toLocaleDateString()}
                  </Text>
                  <Text style={{ width: "25%" }}>{tra.transactionRef}</Text>
