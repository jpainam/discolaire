  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-6 py-4">
        <div className="text-align-center rounded-full border-gray-200 bg-orange-600 px-2 py-1 text-xs font-bold uppercase text-gray-200">
          Under Review
        </div>
      ...
      <div className="bg-gray-200 px-6 py-4">
        ...
        <div className="flex items-center pt-3">
          <div className="flex h-12 w-12 items-center justify-center rounded-full bg-blue-700 font-bold uppercase text-gray-300">
            RK
          </div>
          <div className="ml-4">
