...
export class AnnualService {
  ...
  computeReport(
    ...
    grades3: Awaited<ReturnType<typeof this.reportcard.getGrades>>,
    grades4: Awaited<ReturnType<typeof this.reportcard.getGrades>>,
    grades5: Awaited<ReturnType<typeof this.reportcard.getGrades>>,
    grades6: Awaited<ReturnType<typeof this.reportcard.getGrades>>,
  ): {
    studentsReport: Map<
      string,
      {
    ...
    const allStudents = new Set<string>(
      allGrades.flat().map((g) => g.studentId),
    );
